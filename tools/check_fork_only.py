...
Owner rule, 2026-07-29: every OSS tool we use is forked into `vibeic/` and tracked
by the daily fork-gatekeeper. That rule was checkable only by reading a 605-line
