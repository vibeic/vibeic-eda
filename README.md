...
docker run -d --init --name vibeic-eda ghcr.io/vibeic/vibeic-eda:0.2.75 --skip sleep infinity
...
Current: **0.2.75** — the from-source release that is pinned by the plugin's
