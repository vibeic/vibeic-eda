...
docker run -d --init --name vibeic-eda ghcr.io/vibeic/vibeic-eda:0.2.74 --skip sleep infinity
...
Current: **0.2.74** — the from-source release that is pinned by the plugin's
