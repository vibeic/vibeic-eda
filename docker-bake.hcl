...
variable "IHP_OPEN_PDK_RECIPE" { default = "a9f473" }
variable "OPENROAD_RECIPE" { default = "fff0d1" }
variable "YOSYS_RECIPE" { default = "df0ea5" }
variable "SAT_SOLVERS_RECIPE" { default = "755999" }
variable "NGSPICE_RECIPE" { default = "b4488c" }
...
variable "VERILATOR_RECIPE" { default = "ebc96c" }
variable "GTKWAVE_RECIPE" { default = "2166b3" }
variable "XSCHEM_RECIPE" { default = "52c997" }
variable "SLANG_RECIPE" { default = "190a7d" }
variable "XYCE_RECIPE" { default = "f23bcf" }
...
variable "OPENROAD_REF"    { default = "064126009f2669cde448041773c7634f0fe6ce47" }
variable "YOSYS_REF"       { default = "15ccb684196df3a3116c63daaa7a8acb945d7280" }
...
variable "NGSPICE_REF"     { default = "7c8b0da2e4afd2561a27c673ccc9e3486fe20463" }
...
variable "IVERILOG_REF"    { default = "7af4f4eb501e6ff8023e15190654692b9592258e" }
variable "KLAYOUT_REF"     { default = "e89f9b272eb4dcf676029672bd7bc9aef6a961cb" }
variable "VERILATOR_REF"   { default = "d80e7f884720bce2b07bdd67fe973990fb458c10" }
variable "GTKWAVE_REF" { default = "7d7b4db9e2f5485afe2aeeab0ad112f5b6a9b94b" }
variable "XSCHEM_REF" { default = "210aea296d30ee6cd83c85fbebf104b806bdcba5" }
