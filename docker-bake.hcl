...
variable "OPENROAD_RECIPE" { default = "7f0732" }
...
variable "IVERILOG_RECIPE" { default = "2e377b" }
variable "KLAYOUT_RECIPE" { default = "7ef8ee" }
variable "VERILATOR_RECIPE" { default = "75ea59" }
...
variable "OPENROAD_REF"    { default = "724a389026e6674b693fbe5279ffb8628d76350a" }
...
variable "IVERILOG_REF"    { default = "26933e004e8315a67d291515c11a76857445ea3f" }
variable "KLAYOUT_REF"     { default = "a5a7a2d6be41d4f66338eacdc65ceb573985c3ee" }
variable "VERILATOR_REF"   { default = "e1e7aa414940ed09616ec0e396b83b3ba35a1c1c" }
