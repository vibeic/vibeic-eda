...
variable "OPENROAD_RECIPE" { default = "56b6bf" }
...
variable "IVERILOG_RECIPE" { default = "246df4" }
variable "KLAYOUT_RECIPE" { default = "7ef8ee" }
variable "VERILATOR_RECIPE" { default = "c66901" }
...
variable "OPENROAD_REF"    { default = "9dfaec5fb907a913de0586bf1213cd40cbded1ba" }
...
variable "IVERILOG_REF"    { default = "ef3c73ca45b3c8501dca72ccf53fc657cb04e9c2" }
variable "KLAYOUT_REF"     { default = "a5a7a2d6be41d4f66338eacdc65ceb573985c3ee" }
variable "VERILATOR_REF"   { default = "db524bc35379fcd840c146592e867b96d8e9e82b" }
...
variable "SLANG_REF" { default = "1ffd741812189b1207f019a5aa338c60b662991f" }
